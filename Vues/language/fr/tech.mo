...
$lang['tech'] = array(
 ...
 5 => "Centrale &eacute;lectrique de fusion",
 6 => "Usine de robots",
 7 => "Usine de nanites",
 8 => "Chantier spatial",
 15 => "Centre de d&eacute;fense",
 9 => "Hangar de m&eacute;tal",
 10 => "Hangar de cristal",
 11 => "R&eacute;servoir de deut&eacute;rium",
...
108 => 'R&eacute;acteur &agrave; combustion',
109 => 'R&eacute;acteur &agrave; impulsion',
110 => 'Propulsion hyperespace',
111 => 'Technologie Laser',
112 => 'Technologie Ions',
113 => 'Technologie Plasma',
114 => 'R&eacute;seau de recherche intergalactique',
116 => 'Technologie Pl&eacute;nitude',
...
5 => "La centrale &eacute;lectrique de fusion produit de l'&eacute;nergie en fusionnant 2 atomes d'hydrog&egrave;ne en un atome d'h&eacute;lium.",
6 => "Les usines de robots produisent des robots ouvriers qui servent &agrave; la construction de l'infrastructure plan&eacute;taire. Chaque niveau augmente la vitesse de construction des diff&eacute;rents b&acirc;timents.",
...
15 => "Le Centre de d&eacute;fense permet de construire comme son nom l'indique des installations de d&eacute;fense.",
9 => "Hangar pour minerai avant le traitement.",
10 => "Hangar pour cristal avant le traitement.",
11 => "R&eacute;servoirs g&eacute;ants pour le stockage de deut&eacute;rium.",
12 => "Le laboratoire de recherche est n&eacute;cessaire pour d&eacute;velopper de nouvelles technologies.",
13 => "Le terraformeur permet d'agrandir la surface utile des plan&egrave;tes.",

101 => "Cette technologie permet d'obtenir des informations sur les autres plan&egrave;tes de l'univers.",
102 => "Avec l'augmentation des capacit&eacute;s des ordinateurs, plus de flottes peuvent &ecirc;tre command&eacute;es. Chaque niveau de technologie ordinateur augmente d'une le nombre total de flottes commandables.",
103 => "La technologie armes rend les syst&egrave;mes d'armes plus efficaces. Chaque niveau de technologie armes augmente la puissance des armes des unit&eacute;s par tranche de 10% de la valeur de base.",
104 => "Chaque niveau de la technologie de bouclier augmente l'efficacit&eacute; des boucliers par tranche de 10%.",
105 => "Des alliages sp&eacute;ciaux rendent les vaisseaux spatiaux de plus en plus r&eacute;sistants. L'efficacit&eacute; des protections peut &ecirc;tre augment&eacute;e de 10% par niveau.",
106 => "Maîtriser les diff&eacute;rents types d'&eacute;nergie est n&eacute;cessaire pour de nombreuses technologies.",
107 => "L'int&eacute;gration de la 4eme et de la 5eme dimension permet le d&eacute;veloppement d'un nouveau genre de propulsion plus puissant et efficace.",
108 => "Le d&eacute;veloppement de ces r&eacute;acteurs rend les vaisseaux plus rapides mais chaque niveau n'augmente la vitesse que de 10%.",
109 => "Le r&eacute;acteur &agrave; impulsion est bas&eacute; sur le principe de r&eacute;action disant que la plus grande part de la masse du rayon est gagn&eacute;e comme sous-produit de la fusion d'atomes qui sert &agrave; produire l'&eacute;nergie n&eacute;cessaire.",
110 => "Par une d&eacute;formation spatiale et temporelle dans l'environnement du vaisseau, l'espace est comprim&eacute; ce qui permet de parcourir de longues distances dans un minimum de temps.",
111 => "La concentration de lumi&egrave;re cr&eacute;e un rayon pouvant cr&eacute;er des d&eacute;g&acirc;ts importants  en touchant un objet.",
112 => "Rayon mortel compos&eacute; d'ions acc&eacute;l&eacute;r&eacute;s. En touchant un objet, il cause des d&eacute;g&acirc;ts importants.",
113 => "Une am&eacute;lioration de la technologie d'ions qui n'acc&eacute;l&egrave;re pas des ions mais du plasma tr&egrave;s &eacute;nerg&eacute;tique. Ceci a un effet d&eacute;vastateur en touchant un objet.",
114 => "Les chercheurs de plusieurs plan&egrave;tes utilisent ce r&eacute;seau pour communiquer.",
115 => "Fusion entre le plasma et le ions, elle permettrait dis-t-on de convertir de la mati&egrave;re en antimati&egrave;re ce qui aboutirait à une occultation partielle de b&acirc;timents ou vaisseaux.",
116 => "Permet d augmenter la capacit&eacute; de stockage  des hangars",
117 => "Le terraformage de certaines plan&egrave;tes n'&eacute;tant pas assez rentable pour les grandes entreprises, des scientifiques ont mis au point une am&eacute;lioration, en y ajoutant des expansions.",
118 => "les Scientifiques ont travaill&eacute;s durant des ann&eacute;es dans le secret , pour decouvrir un moyen de d&eacute;placement instantan&eacute; des ressources.",
119 => "Une quantit&eacute; concentr&eacute;e de particules de graviton, r&eacute;seau artificiel de gravitation, est propuls&eacute;e, capable de d&eacute;truire des vaisseaux ou m&ecirc;me des lunes.",
