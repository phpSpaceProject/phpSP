...
<tr>
	...
	<th colspan="2">émoticones et BBCode :<br />Vous pouvez utiliser le BBCode et des émoticones pour embellir vos méssages...<br /><br />Pour utiliser les émoticones de base fournis par le staff :<br />
	<table>
	<tr>
		<td><img src="images/Games/emoticones/cry.png" alt="pleur�" width="50" height="50" /> = cry</td>
	...
	<tr>
		...
		<td><img src="images/Games/emoticones/shamed.png" alt="g�n�" width="50" height="50"> = shamed</td>
	</tr>
	<tr>
		
		<td><img src="images/Games/emoticones/socute.png" alt="ador�" width="50" height="50"> = socute</td>
		<td><img src="images/Games/emoticones/sorry.png" alt="d�sol�" width="50" height="50"> = sorry</td>
	...
	Texte en gras = [b]Texte[/b]<br />Texte soulign� = [u]Texte[/u]<br />Texte en italliqiue = [i]Texte[/i]<br />Une image = [img]http://liendelimage.com[/img]</th>
</tr>
</table>
</form>
</center>