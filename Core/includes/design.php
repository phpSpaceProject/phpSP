	...
	if (defined('LOGIN') or defined('LEFT')) 
	{
		...
		<div class="hauteur">
			...
			'.$br.'
				...
				<a href="'. ACCUEIL_BASE .'changelog" title="'.$lang['changelog_link'].'">'.$lang['changelog_link'].'</a>
			</div>
		</div>
		';
	}
            ...
            <div class="snap-drawer snap-drawer-left">
                <div>
                    ...
                    <ul>
                        ...
                        <li><a href="'. ACCUEIL_BASE .'changelog" title="'.$lang['changelog_link'].'">'.$lang['changelog_link'].'</a></li>
                    </ul>
                </div>
            </div>
        </div>';
