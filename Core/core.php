...
//on va chercher la table config .
$Configs = Model::load("config");//attention c'est le model config est nom le fichier de connexion
$config = $Configs->find(array('fields' =>"`config_name`,`config_value`"));
foreach ($config as $c)
{
