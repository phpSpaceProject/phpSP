...
$lang['fl_add_to_attack']					= 'a bien etait ajouté a l attaque groupé.';
$lang['fl_dont_exist']						= 'n a pas etait ajouté a l attaque groupé.';
$lang['fl_acs_invitation_message']			= ' vous a invité à une AG - (attaque groupé).';
$lang['fl_acs_invitation_title']			= 'Invitation pour une AG';
$lang['fl_sac_of_fleet']					= 'flotte AG';
$lang['fl_modify_sac_name']					= 'Changer le nom de l attaque groupé';
$lang['fl_members_invited']					= 'Liste des membres invités';
$lang['fl_invite_members']					= 'Invités des autres membres';
